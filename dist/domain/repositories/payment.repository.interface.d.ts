import { ProcessPaymentRequest, ProcessPaymentResponse, LoadPaymentByOrderRequest, LoadPaymentByOrderResponse, LoadPaymentByIdRequest, LoadPaymentByIdResponse } from '../models/payment.model';
